...
using PckTool.Core.WWise.Bank;
using PckTool.Core.WWise.Chunks;
using PckTool.Core.WWise.Enums;
using PckTool.Core.WWise.Structs;
...
public class SoundBank
{
    ...
    public bool IsValid => BankHeaderChunk?.IsValid == true;
