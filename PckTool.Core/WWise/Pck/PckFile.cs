...
public class PckFile : IDisposable
{
    ...
    private bool LoadFromReader(BinaryReader reader)
    {
        ...
        var languageMapSize = reader.ReadUInt32();
        var soundBanksLutSize = reader.ReadUInt32();
        var stmFilesLutSize = reader.ReadUInt32();
        var externalLutsSize = reader.ReadUInt32();
        ...
        if (!languageMap.Read(reader, languageMapSize))
        {
            return false;
        }
        ...
        if (!soundBanks.Read(reader, soundBanksLutSize))
        {
            return false;
        }
        ...
        if (!streamingFiles.Read(reader, stmFilesLutSize))
        {
            return false;
        }
        ...
        if (!externalFiles.Read(reader, externalLutsSize))
        {
            return false;
        }
