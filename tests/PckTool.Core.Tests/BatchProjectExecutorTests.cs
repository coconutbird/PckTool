...
#region DryRun Tests
    ...
    public void Execute_WithDryRun_ShouldNotModifyFiles()
    {
        ...
        try
        {
            ...
            // Act
            var result = _executor.Execute(project, dryRun: true);
...
#region Event Tests
    ...
    public void Execute_ShouldRaiseActionStartedEvent()
    {
        ...
        try
        {
            ...
            // Act
            _executor.Execute(project, dryRun: true);
...
#region Replace Execution Tests
    ...
    public void Execute_ReplaceWem_ShouldCallReplaceWemOnPckFile()
    {
        ...
        try
        {
            ...
            // Act
            _executor.Execute(project, dryRun: false);

            // Assert
            _mockPckFile.Received(1).ReplaceWem(0x12345678, Arg.Any<byte[]>(), true);
        }
        finally
        {
            CleanupTempFile(tempFile);
    ...
    public void Execute_WhenWemNotFound_ShouldReturnFailedResult()
    {
        ...
        try
        {
            ...
            // Act
            var result = _executor.Execute(project, dryRun: false);
